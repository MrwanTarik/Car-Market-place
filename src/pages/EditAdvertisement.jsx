    ...
    async function getCar(id) {
      try {
        ...
        setFormData({
          ...
          sideCurtains: false,
          uploadedImages: [],
          vehicle_front_view_image: featuredImagesArr.vehicle_front_view_image,
          vehicle_back_view_image: featuredImagesArr.vehicle_back_view_image,
          vehicle_front_panel_image:
            featuredImagesArr.vehicle_front_panel_image,
        });
